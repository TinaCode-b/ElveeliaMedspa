const BUSINESS = {
  ...
  whatsappMessage:
    "Hello Elveelia Medspa, I would like to book an appointment.",
...
function populateBusinessInfo() {
  ...
  document
    .querySelectorAll(
      "#whatsappFloat, #whatsappUsBtn, #whatsappInlineLink"
    )
    .forEach((el) => {
  ...
  if (callBtn) {
    callBtn.setAttribute("href", buildTelLink());
  }
...
function initAppointmentForm() {
  ...
  if (!form || !confirmation || !requestAnotherBtn) {
    return;
  }
